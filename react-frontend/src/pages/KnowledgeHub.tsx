...
const KnowledgeHub: React.FC<KnowledgeHubProps> = ({ sidebarOpen = false, sidebarWidth = 280 }) => {
          ...
          {messages.length === 0 && (
            ...
            >
              ...
              <Typography variant="h6" color="text.secondary" sx={{ mb: 4, maxWidth: 600 }}>
                Ask questions about technical documentation, product information, 
                and get detailed explanations from our knowledge base.
              </Typography>
